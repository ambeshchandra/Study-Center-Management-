...
// Componente: PopCalendarAjaxNet.js(1.0.8)
...
{
	var objPopCalList=[]
	var PopCalendar={majorVersion:1,minorVersion:0.8,newCalendar:new Function("_name","return(PopCalGetCalendarInstance(_name))")}
}
	...
	if(PopCal)
	{
		...
		if(PopCal.initialized==0)
		{
			if(!PopCalGetById("popupSuperYear"))
			{
				if(objPopCal.ie)
				{
					var sComponents="<div id='CalendarLoadFilters' style='z-index:13000;position:absolute;top:0px;left:0px;display:none;filter="+'"'+"alpha() blendTrans()"+'"'+"'></div>"
					if(objPopCal.ieVersion>=5.5)
					{
						sComponents+="<iframe id='popupOverShadow' src='javascript:false;' scrolling=no frameborder=0 style='position:absolute;left:0px;top:0px;width:0px;height:0px;z-index:15000;display:none;filter:progid:DXImageTransform.Microsoft.Alpha(opacity=0);'></iframe>"
						sComponents+="<iframe id='popupOverCalendar' src='javascript:false;' scrolling=no frameborder=0 style='position:absolute;left:0px;top:0px;width:0px;height:0px;z-index:16000;display:none;filter:progid:DXImageTransform.Microsoft.Alpha(opacity=0);'></iframe>"
						sComponents+="<iframe id='popupOverYearMonth' src='javascript:false;' scrolling=no frameborder=0 style='position:absolute;left:0px;top:0px;width:0px;height:0px;z-index:17000;display:none;filter:progid:DXImageTransform.Microsoft.Alpha(opacity=0);'></iframe>"
					}
...
function PopCalUpMonth(l)
{
	...
	PopCal.popupSuperMonth.style.zIndex=17500
...
function PopCalUpYear(l)
{
	...
	PopCal.popupSuperYear.style.zIndex=17500
